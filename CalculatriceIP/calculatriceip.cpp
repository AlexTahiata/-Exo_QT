/**
  ...
  * @brief Définition de la classe CalculatriceIP
  * @version 1.8
  * @date   14 mai 2019
...
#include <QMessageBox>
/**
 * @brief CalculatriceIP::CalculatriceIP
 * @details Constructeur de la classe CalculatriceIP
 * @param parent
 */
...
/**
 * @brief CalculatriceIP::~CalculatriceIP
 * @details Destructeur de la classe CalculatriceIP.
 */
...
/**
 * @brief CalculatriceIP::on_pushButtonCalculer_clicked
 * @details Fonction qui calcule l'adresse du réseau lors d'un clic sur le bouton associé à cette action.
 */
...
/**
 * @brief CalculatriceIP::ConvertirTabOctetEnQString
 * @param tabOctet
 * @details Fonction qui convertit le taboctet en qstring.
 * @return
 */
...
/**
 * @brief CalculatriceIP::on_pushButtonPropos_clicked
 * @details
 */
